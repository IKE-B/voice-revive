...
//==============================================================================
GainEQProcessorAudioProcessor::GainEQProcessorAudioProcessor()
...
//==============================================================================
const juce::String GainEQProcessorAudioProcessor::getName() const
{
    return JucePlugin_Name;
}

bool GainEQProcessorAudioProcessor::acceptsMidi() const
{
...
bool GainEQProcessorAudioProcessor::producesMidi() const
{
...
bool GainEQProcessorAudioProcessor::isMidiEffect() const
{
   #if JucePlugin_IsMidiEffect
    return true;
   #else
...
double GainEQProcessorAudioProcessor::getTailLengthSeconds() const
{
    return 0.0;
}

int GainEQProcessorAudioProcessor::getNumPrograms()
{
    return 1;   // NB: some hosts don't cope very well if you tell them there are 0 programs,
                // so this should be at least 1, even if you're not really implementing programs.
}

int GainEQProcessorAudioProcessor::getCurrentProgram()
{
    return 0;
}

void GainEQProcessorAudioProcessor::setCurrentProgram (int index)
{
}

const juce::String GainEQProcessorAudioProcessor::getProgramName (int index)
{
    return {};
}

void GainEQProcessorAudioProcessor::changeProgramName (int index, const juce::String& newName)
{
}

//==============================================================================
void GainEQProcessorAudioProcessor::prepareToPlay (double sampleRate, int samplesPerBlock)
{
...
void GainEQProcessorAudioProcessor::releaseResources()
{
...
#ifndef JucePlugin_PreferredChannelConfigurations
bool GainEQProcessorAudioProcessor::isBusesLayoutSupported (const BusesLayout& layouts) const
{
  #if JucePlugin_IsMidiEffect
...
void GainEQProcessorAudioProcessor::updateState()
{
    for (auto& comp : compressors)
    {
...
void GainEQProcessorAudioProcessor::splitBands(const juce::AudioBuffer<float>& inputBuffer)
{
...
void GainEQProcessorAudioProcessor::processBlock (juce::AudioBuffer<float>& buffer, juce::MidiBuffer& midiMessages)
{
...
//==============================================================================
bool GainEQProcessorAudioProcessor::hasEditor() const
{
    return true; // (change this to false if you choose to not supply an editor)
}

juce::AudioProcessorEditor* GainEQProcessorAudioProcessor::createEditor()
{
    //return new GainEQProcessorAudioProcessorEditor (*this);
    return new juce::GenericAudioProcessorEditor(*this);
}

//==============================================================================
void GainEQProcessorAudioProcessor::getStateInformation (juce::MemoryBlock& destData)
{
...
void GainEQProcessorAudioProcessor::setStateInformation (const void* data, int sizeInBytes)
{
...
juce::AudioProcessorValueTreeState::ParameterLayout GainEQProcessorAudioProcessor::createParameterLayout()
{
...
{
    return new GainEQProcessorAudioProcessor();
}
